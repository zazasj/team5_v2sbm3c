...
<script type="text/javascript">
  window.onload = ()=> {
    ...
    document.getElementById('btn_loadDefault').addEventListener('click', () => {
      document.getElementById('pid').value = 'user1@naver.com';
...
<c:import url="/menu/top.do" />
  ...
  <DIV class='content_body'> 
    <DIV style='width: 40%; margin: 0px auto;'>
      <form name='frm' method='POST' action='./findpwd.do'>
      ...
      <!-- 로딩 GIF -->
        ...
        <div class="form-group">
          ...
          <input type='text' class="form-control" name='pid' id='pid' 
                    value='' required="required" style='width: 80%;' placeholder="ID">
        </div> 
        ...
        <div class="form-group">
          ...
          <input type='text' class="form-control" name='name' id='name' 
                    ...
                    style='width: 80%;' placeholder="성명" autofocus="autofocus">
        </div>   
