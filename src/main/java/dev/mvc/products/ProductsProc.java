...
public class ProductsProc implements ProductsProcInter {
  ...
  public ArrayList<ProductsVO> list_all_search_paging(ProductsVO productsVO) {
    ...
    */
    ...
    ArrayList<ProductsVO> list = this.productsDAO.list_all_search_paging(productsVO);
  ...
  public int search_count_all(HashMap<String, Object> hashMap) {
    int cnt = this.productsDAO.search_count_all(hashMap);
    return cnt;
  }  
  ...
  public ArrayList<ProductsVO> list_all_1_search_paging(ProductsVO productsVO) {
    ...
    */
    ...
    ArrayList<ProductsVO> list = this.productsDAO.list_all_1_search_paging(productsVO);
...
//    str.append("현재 페이지: " + nowPage + " / " + totalPage + "  "); 
  ...
  public int search_count_1(HashMap<String, Object> hashMap) {
    int cnt = this.productsDAO.search_count_1(hashMap);
    return cnt;
  }
  ...
  public ArrayList<ProductsVO> list_all_2_search_paging(ProductsVO productsVO) {
    ...
    */
    ...
    ArrayList<ProductsVO> list = this.productsDAO.list_all_2_search_paging(productsVO);
  ...
  public int search_count_2(HashMap<String, Object> hashMap) {
    int cnt = this.productsDAO.search_count_2(hashMap);
    return cnt;
  }
  ...
  public ArrayList<ProductsVO> list_all_3_search_paging(ProductsVO productsVO) {
    ...
    */
    ...
    ArrayList<ProductsVO> list = this.productsDAO.list_all_3_search_paging(productsVO);
  ...
  public int search_count_3(HashMap<String, Object> hashMap) {
    int cnt = this.productsDAO.search_count_3(hashMap);
    return cnt;
  }
  ...
  public ArrayList<ProductsVO> list_all_4_search_paging(ProductsVO productsVO) {
    ...
    */
    ...
    ArrayList<ProductsVO> list = this.productsDAO.list_all_4_search_paging(productsVO);
  ...
  public int search_count_4(HashMap<String, Object> hashMap) {
    int cnt = this.productsDAO.search_count_4(hashMap);
    return cnt;
  }
  ...
  public ArrayList<ProductsVO> list_all_5_search_paging(ProductsVO productsVO) {
    ...
    */
    ...
    ArrayList<ProductsVO> list = this.productsDAO.list_all_5_search_paging(productsVO);
  ...
  public int search_count_5(HashMap<String, Object> hashMap) {
    int cnt = this.productsDAO.search_count_5(hashMap);
    return cnt;
  }
